        ...
        <div class="card card-user">
            <div class="image">
                <?php
              		if ($_SESSION["FOTOUSER"] !== '') {
              			echo '<img src="up_arquivos/Usuarios/'.$tMC["FotoCapa_U"].'" alt="...">';
              		} else {
              			echo '<img src="up_arquivos/Usuarios/emptyBack.png" alt="...">';
              		}
              	?>
            </div>
            <div class="card-content">
                <div class="author">
                  	<?php
                  		if ($_SESSION["FOTOUSER"] !== '') {
                  			echo '<img class="avatar border-white" src="up_arquivos/Usuarios/'.$_SESSION["FOTOUSER"].'" style="background-color: #fff;">';
                  		} else {
                  			echo '<img class="avatar border-white" src="up_arquivos/Usuarios/emptyPerson.png" style="background-color: #fff;">';
                  		}
                  	?>

                  <h4 class="card-title"><?=$tMC['NOME_U']?><br>
                     <a href="#"><small>@<?=$tMC['NOME_SOCIAL_U']?></small></a>
                  </h4>
                </div>
            </div>
            <hr>
            <div class="alinhamento-centralizado">
                <div class="row" style="cursor: pointer;">
                    <div class="col-md-4 pad20" data-toggle='modal' data-target='#ModalAlteraFotoCapa'>
                        <div><img src="up_arquivos/Usuarios/BackDefault.png"></div>
                        <p>Alterar Capa</p>
                    </div>
                    <div class="col-md-4 pad20" data-toggle='modal' data-target='#ModalAlteraFotoPerfil'>
                        <div><img src="up_arquivos/Usuarios/UsuarioDefault.png"></div>
                        <p>Alterar Foto Perfil</p>
                    </div>
                    <div class="col-md-4 pad20" data-toggle='modal' data-target='#ModalAlteraSenha'>
                    	<div><img src="up_arquivos/Usuarios/AlterarSenha.png"></div>
                        <p>Alterar Senha</p>
                    </div>
                </div>
            </div>
    ...
    <div class="col-lg-8 col-md-7">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Editar Meus Dados de Usuário</h4>
                <hr>
            </div>
            <div class="card-content">
                <form>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control border-input" value="<?=$tMC['NOME_U']?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Nome Social</label>
                                <input type="text" class="form-control border-input" value="<?=$tMC['NOME_SOCIAL_U']?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>CPF</label>
                                <input type="text" class="form-control border-input" value="<?=$tMC['CPF_U']?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>E-Mail</label>
                                <input type="text" class="form-control border-input" value="<?=$tMC['EMAIL_U']?>">
                            </div>
                        </div>
                    </div>
                    
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-default">Editar Usuário</button>
                    </div>
