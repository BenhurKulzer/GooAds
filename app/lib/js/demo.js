                    ...
                    html: '<hr>' +
                            '<form method="post">' +
                              '<div class="form-group">' +
                                  ...
                                  '<input id="input-field" type="text" class="form-control" placeholder="Nome do Responsável" />' +
                                  '<label>CPF do Responsável</label>' +
                                  '<input id="input-field" type="text" class="form-control" placeholder="CPF do Responsável" />' +
                                  '<label>E-Mail do Responsável</label>' +
                                  '<input id="input-field" type="text" class="form-control" placeholder="E-Mail do Responsável" />' +
                                  '<label>Telefone do Responsável</label>' +
                                  '<input id="input-field" type="text" class="form-control" placeholder="Telefone do Responsável" />' +
                                  '<label>Data de Nascimento do Responsável</label>' +
                                  '<input id="input-field" type="text" class="form-control" placeholder="Data de Nascimento do Responsável" />' +
                              '</div>' +
                            '</form>',
                    showCancelButton: true,
                    confirmButtonClass: 'btn btn-success btn-fill',
...
//          format: 'H:mm',    // use this format if you want the 24hours timepicker
	...
	showNotification: function(from, align){
    	...
    	$.notify({
        	...
        	message: "Bem Vindo(a) ao <b>Sistema de Atendimentos</b> - SOS HD Recuperação de Dados."
